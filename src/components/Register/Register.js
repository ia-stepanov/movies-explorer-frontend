  ...
  return (
    <Form header="Добро пожаловать!" submit="Зарегистрироваться" question="Уже зарегистрированы?" link="Войти" path="/signin">
      <label className="form__item">
        ...
        <input type="text" className="form__field" placeholder="Виталий" required />
      ...
      <label className="form__item">
        ...
        <input type="password" className="form__field form__field_color-error" placeholder="••••••••••••••" required />
